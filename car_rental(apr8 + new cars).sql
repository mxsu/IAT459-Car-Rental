...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 09, 2025 at 07:39 AM
...
(1016, 'chan.owen@gmail.com', 'Dodge_Caravan_2023', 'Vancouver International Airport ', '2025-04-18', '2025-04-23', 0),
(1017, 'chan.11owen@gmail.com', 'Dodge_Caravan_2023', 'Vancouver International Airport ', '2025-04-09', '2025-04-11', 0),
(1018, 'gwill@gmail.com', 'Toyota_Corolla_2023', 'Vancouver International Airport ', '2025-04-16', '2025-04-19', 0);
...
(45, 'Ford_Lightning_2024', 'Vancouver International Airport (YVR)'),
(46, 'Ford_Lightning_2024', 'Vancouver Main Street Science World'),
(47, 'Nissan_Leaf_2024', 'Vancouver International Airport (YVR)'),
(48, 'Nissan_Leaf_2024', 'Vancouver Main Street Science World');
...
('Ford_Lightning_2024', 'Ford', 'F150 Lightning', 'Truck', 'AWD', 'Electric', 5, 'Unlimited', 95),
...
('Nissan_Leaf_2024', 'Nissan', 'Leaf', 'Car', 'FWD', 'Electric', 5, 'Unlimited', 70),
...
(85077268, '2025-04-08', 375, 1016),
(85077269, '2025-04-08', 150, 1017),
(85077270, '2025-04-08', 180, 1018);
...
--
ALTER TABLE `booking`
  MODIFY `Booking ID` int(8) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1019;
...
--
ALTER TABLE `payment`
  MODIFY `payment_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=85077271;
